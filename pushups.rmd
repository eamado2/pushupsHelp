...
It appears that the skill player does more pushups than the line players according to the boxplot. There is one skill player that is doing a significant amount more pushups than everyone else. 
...
The question was, "is there a difference in the average pushups of players in the line or skill positions?"
...
A t-test of difference in means gave a p-value of 0.000009421, this is less than 0.05, so we reject the null hypothesis and conclude we have evidence of a difference in average pushups between players in the two positions. 